...
public class UITestSeleniumHelper {
	...
	public final static String FIREFOX_DRIVER_PATH=System.getProperty(
			"webdriver.gecko.driver",DRIVER_PATH+File.separator+"geckodriver"+execExtn);
	public final static String CR_DRIVER_PATH = System.getProperty(
			"webdriver.chrome.driver", DRIVER_PATH+File.separator+"chromedriver"+execExtn);
	public final static String IE_DRIVER_PATH = System.getProperty(
			"webdriver.ie.driver", DRIVER_PATH+File.separator+"IEDriverServer"+execExtn);
	public final static String IE_EDGE_DRIVER_PATH = System.getProperty(
			"webdriver.ie.driver", DRIVER_PATH+File.separator+"MicrosoftWebDriver"+execExtn);

	public final static long WAIT_TIME = Long.parseLong(System.getProperty(
			"wait.time", "60")); // secs
	...
	public String getCurrentDateTime(String format) {
		String dateSuffix = new SimpleDateFormat(format).format(
